...
export { typeCheck } from "src/components/typeCheck.js";
export { addFirestore } from "src/components/addFirestore.js";
...
export { faSearchPlus } from "@fortawesome/free-solid-svg-icons";
